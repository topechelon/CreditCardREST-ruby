...
module CreditCardRestClient
  ...
  class ChargeDetails
    ...
    def hash
      [merchant_account_number, card_number, card_verification_number, card_expiration_date, charge_amount, charge_comment, charge_order_id, avs_name, avs_street_address1, avs_street_address2, avs_city, avs_state_abbreviation, avs_zip_code].hash
    end
